...
export const announceImageOverlay = getEl<HTMLDivElement>('announce-image-overlay');
export const announceImageThumb = announceImageOverlay.querySelector('.ai-thumb') as HTMLImageElement;
export const announceImageTitle = announceImageOverlay.querySelector('.ai-title') as HTMLSpanElement;
export const announceImageClose = announceImageOverlay.querySelector('.ai-close') as HTMLButtonElement;
export const announceImageFullscreen = getEl<HTMLDivElement>('announce-image-fullscreen');
export const announceImageFullscreenImg = announceImageFullscreen.querySelector('img') as HTMLImageElement;
